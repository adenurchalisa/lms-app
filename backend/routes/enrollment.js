...
// Student join course
router.post('/courses/:courseId/enroll', auth, enrollmentController.enrollCourse);
...
router.get('/courses/:courseId/students', auth, enrollmentController.getEnrolledStudents);
